...
export class RoleService {
  ...
  async assignRole(roleId: string, customerId: string, invalidateAuthCode = true): Promise<Customer> {
    invalidateAuthCode && (await AuthService.invalidateAuthCode(customerId));
  ...
  async unassignRole(roleId: string, customerId: string, invalidateAuthCode = true): Promise<Customer> {
    invalidateAuthCode && (await AuthService.invalidateAuthCode(customerId));
    return (await customer
