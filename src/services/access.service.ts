...
import { customer, meal, mealPack, card, transaction, notification, allergy, subscription, plan } from "../models";

import capitalize from "lodash/capitalize";
import consola from "consola";

// TODO: Add accessible schema union types.
export type SchemaTypes = "customer" | "meal" | "plan" | "mealPack" | "card" | "transaction" | "notification" | "allergy" | 'subscription';
...
export class AccessService {
  ...
  static getModel(schema: SchemaTypes): ReturnModelType<DocumentType<any>, any> {
    ...
    const map: { [key in SchemaTypes]: DocumentType<any> } = { plan, customer, meal, mealPack, card, transaction, notification, allergy, subscription };
