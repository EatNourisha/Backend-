import { Meal, MealLineup, MealPack, MealExtras, PartyMealRequest, Category, FoodBox } from "../../models";
...
export interface FoodBoxDto extends Omit<FoodBox, "_id" | "created_at" | "updated_at"> {}
